        ...
        <div class="profile-container">
            ...
            <div class="profile-info">
                ...
                <div class="info-card">
                    ...
                    <p><strong>Дата регистрации:</strong> ${user?.created_at ? new Date(user.created_at).toLocaleDateString() : 'не указана'}</p>
                </div>
            </div>
    ...
    try {
        ...
        container.innerHTML = favoriteCourses.map(course => {
            const seatsDisplay = course.seats !== undefined
                ? (course.seats === 0
                    ? '<span style="color: red;">📊 Свободных мест: 0 (нет свободных мест)</span>'
                    : `📊 Свободных мест: ${course.seats}`)
                : '';
